...
declare namespace SC {
  ...
  export interface Instance {
    ...
    setEventHandler(
      eventName: "inclusion",
      callback: (eventName: string, attachScope: SC.AttachScope, inclusionKey: InclusionKey, modelKey: ModelKey) => void
    ): void;
    setEventHandler(
      eventName: "meta_data",
    ...
    setEventHandler(
      eventName: "post_draw",
      callback: (eventName: string, stats: FrameStats, camera: Camera, visiblePoints: number[]) => void
    ): void;
    ...
    setEventHandler(
      ...
      callback: (eventName: string, attachScope: SC.AttachScope, prototypeInstanceCount: number) => void
    ): void;
    setEventHandler(
